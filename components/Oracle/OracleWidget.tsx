    ...
    <div className="flex flex-col h-full bg-slate-900/50 backdrop-blur-md border border-slate-800 rounded-2xl overflow-hidden shadow-2xl relative">
      ...
      <div className="p-4 border-b border-slate-800 flex justify-between items-center bg-slate-900/80">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-bold text-slate-100 tracking-wide">THE ORACLE</h2>
        </div>
        <div className="text-xs font-mono text-slate-500">v2.5 FLASH</div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {oracleHistory.map((msg) => (
          ...
          >
            <div
              className={`max-w-[85%] p-3 rounded-xl text-sm leading-relaxed whitespace-pre-wrap break-words ${
                msg.role === 'user'
