...
export const IntelResults: React.FC<IntelResultsProps> = ({ result, query, onSave, onFollowUp, isLoading }) => {
      ...
      {summaryBullets.length > 0 && (
        <div className="border border-slate-800 bg-gradient-to-br from-slate-900/80 to-slate-900/40 rounded-lg overflow-hidden">
          ...
          <div className="p-4 space-y-3">
            {isConversationMode ? (
              // Conversation mode: Just show the text naturally
              <div className="text-slate-300 text-sm leading-relaxed whitespace-pre-wrap">
                {summaryBullets[0]}
              </div>
            ) : (
              // Research mode: Show as numbered bullets
